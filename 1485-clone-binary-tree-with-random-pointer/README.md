<h2><a href="https://leetcode.com/problems/clone-binary-tree-with-random-pointer">1624. Clone Binary Tree With Random Pointer</a></h2><h3>Medium</h3><hr><p>A binary tree is given such that each node contains an additional random pointer which could point to any node in the tree or null.</p>
