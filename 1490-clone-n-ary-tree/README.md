<h2><a href="https://leetcode.com/problems/clone-n-ary-tree/?envType=problem-list-v2&envId=vyx79jrr">1634. Clone N-ary Tree</a></h2><h3>Medium</h3><hr><p>Given a <code>root</code> of an N-ary tree, return a <a href="https://en.wikipedia.org/wiki/Object_copying#Deep_copy" target="_blank"><strong>deep copy</strong></a> (clone) of the tree.</p>
