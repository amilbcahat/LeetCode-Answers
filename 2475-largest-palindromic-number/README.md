<h2><a href="https://leetcode.com/problems/largest-palindromic-number">2475. Largest Palindromic Number</a></h2><h3>Medium</h3><hr><p>You are given a string <code>num</code> consisting of digits only.</p>
